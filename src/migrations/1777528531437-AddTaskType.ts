...
export class AddTaskType1777528531437 implements MigrationInterface {
    name = 'AddTaskType1777528531437'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tasks_type_enum" AS ENUM('cooking', 'cleaning', 'plumbing', 'general')`);
        await queryRunner.query(`ALTER TABLE "tasks" ADD "type" "public"."tasks_type_enum" NOT NULL DEFAULT 'general'`);
